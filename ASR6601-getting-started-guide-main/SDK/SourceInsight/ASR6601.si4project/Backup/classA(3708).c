 ...
 */
#define LORAWAN_APP_DATA_MAX_SIZE                           23
...
{	
	 ...
	 * status: 0:i2c 1:adc1 2:adc0 3: time is queried
	 */
	AppDataSize = 4;
	// ADC scan
	...
	if(AppData[0] & 0x08 == 0x08)
		AppDataSize += 3;
	else
		AppDataSize = 1 + 3 + AppData[1] / 2 + AppData[2] / 2 + AppData[3] / 2;
//	printf("%x\r\n",AppData[16]);
	//	unsigned char i;
